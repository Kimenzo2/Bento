...
By accessing or using Genesis ("the Service"), you agree to be bound by these
Terms of Service ("Terms"). If you disagree with any part of these Terms, you
may not access the Service.

## 2. Description of Service

Genesis is a visual learning platform that uses AI technology to help users
create interactive, illustrated books and educational content. The Service
includes:

- AI-powered content generation
- Illustration creation and styling
- Interactive voice tutoring
...
- Create inappropriate or harmful content
...
- **Empire ($199.99/month)**: Unlimited everything, custom AI training, API
  access
...
- **Free Plan**: No refunds applicable
- **Paid Plans**: 7-day money-back guarantee for first-time subscribers
- No refunds for partial months or unused features
- Refunds at our discretion for service issues
...
- You may cancel before renewal to avoid price changes

## 5. Acceptable Use Policy

You agree **NOT** to:

- Create content that is illegal, harmful, threatening, abusive, harassing,
...
- Create content promoting violence, hate speech, or discrimination

## 6. Intellectual Property Rights

### 6.1 Your Content

- You retain ownership of content you create using Genesis
- You grant us a license to store, process, and display your content to provide
  the Service
...
- AI-generated text and images become your property upon creation
...
### 6.3 Genesis Platform

- The Genesis platform, code, design, and branding are our property
- You may not copy, modify, or distribute our proprietary technology
- Trademarks "Genesis" and our logo are protected
...
- Suspend accounts that repeatedly violate policies
...
- Change tier limits with 30 days' notice to existing subscribers
...
You agree to indemnify and hold Genesis harmless from any claims, damages, or
...
Your use of Genesis is also governed by our [Privacy Policy](PRIVACY_POLICY.md).
...
If your content was removed, you may file a counter-notice with the same
information.
...
_By using Genesis, you acknowledge that you have read, understood, and agree to
be bound by these Terms of Service._
