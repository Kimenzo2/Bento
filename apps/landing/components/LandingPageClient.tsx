...
import { IcoCrown, IcoRocket, IcoWand } from './IconscoutIcons';
      ...
      <div className="mx-auto max-w-6xl flex items-center justify-between px-5 md:px-12 h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            ...
            onClick={() => router.push('/auth?returnTo=/welcome/onboarding')}
          >
            ...
            <div className="px-5 pb-6 pt-2 flex flex-col gap-1">
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <button
                  ...
                  onClick={() => {
                    setMobileMenuOpen(false);
                    router.push('/auth?returnTo=/welcome/onboarding');
                  }}
                >
                  {t('landing.getStarted', 'Get Started')}
                </button>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {realms.map((realm, i) => (
          <motion.button
            ...
            onClick={() => router.push(`/auth?returnTo=${encodeURIComponent(`/welcome/onboarding?realm=${realm.realm}`)}`)}
