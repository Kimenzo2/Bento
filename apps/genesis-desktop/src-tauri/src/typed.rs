...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            // Integrations — COMMENTED OUT FOR BISECTION (pass1)
            ...
            // Notes — COMMENTED OUT FOR BISECTION (pass1)
            ...
            // Settings — COMMENTED OUT FOR BISECTION (pass1)
            ...
            // Spectrum — COMMENTED OUT FOR BISECTION (pass1)
