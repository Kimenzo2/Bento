...
fn draw_title_page(
    ...
    text_color(layer, &format!("Page 1"), 7.0, PAGE_W - MARGIN - 20.0, footer_y, font, COLOR_MUTED);
}
...
fn draw_category_table(
    ...
    text_color(layer, &format!("Page — Report generated by Bento Desktop"), 7.0, MARGIN, 18.0, font, COLOR_MUTED);
}
