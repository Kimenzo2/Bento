            ...
            {#each items as entry (entry.id)}
              ...
              >
                ...
                <span class="pv-item-actions" onclick={(e) => e.stopPropagation()}>
                  <button class="pv-icon-btn" onclick={() => copyText(entry.password, `copy-${entry.id}`)} aria-label="Copy password" use:tooltip={{ text: "Copy password" }}>
                  ...
                  <button class="pv-icon-btn" onclick={() => openEditForm(entry)} aria-label="Edit" use:tooltip={{ text: "Edit entry" }}>
                ...
                <div class="pv-detail">
                  <div class="pv-detail-field">
                    ...
                    <div class="pv-detail-row">
                      ...
                      <button class="pv-icon-btn" onclick={() => copyText(entry.username, `user-${entry.id}`)} aria-label="Copy username" use:tooltip={{ text: "Copy username" }}>
                  ...
                  <div class="pv-detail-field">
                    ...
                    <div class="pv-detail-row">
                      ...
                      <span class="pv-detail-actions">
                        <button class="pv-icon-btn" onclick={() => togglePassword(entry.id)} aria-label={visiblePasswords.has(entry.id) ? "Hide" : "Show"} use:tooltip={{ text: visiblePasswords.has(entry.id) ? "Hide password" : "Show password" }}>
                        ...
                        <button class="pv-icon-btn" onclick={() => copyText(entry.password, `pass-${entry.id}`)} aria-label="Copy password" use:tooltip={{ text: "Copy password" }}>
                  ...
                  <div class="pv-detail-footer">
                    <button class="pv-delete-btn" onclick={() => deleteEntry(entry.id)} aria-label="Delete entry" use:tooltip={{ text: "Delete entry" }}>
  ...
  <div class="pv-modal-overlay" role="presentation" onclick={closeForm}>
    <div class="pv-modal" onclick={(e) => e.stopPropagation()} role="dialog" aria-label={editingId ? "Edit entry" : "New entry"}>
      <div class="pv-modal-header">
        ...
        <button class="pv-icon-btn" onclick={closeForm} aria-label="Close" use:tooltip={{ text: "Close" }}>
