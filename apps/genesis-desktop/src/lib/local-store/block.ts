...
export interface BlockComponent {
	...
	renderMentions?(rootId: string, node: any, marks: Mark[], getValue: () => string, param?: any): void;
	renderObjects?(rootId: string, node: any, marks: Mark[], getValue: () => string, props: any, param?: any): void;
	renderLinks?(rootId: string, node: any, marks: Mark[], getValue: () => string, props: any, param?: any): void;
...
export function isTextHeader(style: TextStyle): boolean {
	return style === TextStyle.Header1 || style === TextStyle.Header2 ||
		style === TextStyle.Header3 || style === TextStyle.Header4;
}

export function isTextToggle(style: TextStyle): boolean {
	return style === TextStyle.Toggle || style === TextStyle.ToggleHeader1 ||
		style === TextStyle.ToggleHeader2 || style === TextStyle.ToggleHeader3;
}
