...
export const starterModuleLoaders = {
  ...
  passwords: () => import("../../modules/passwords/App.svelte") as unknown as Promise<StarterModule>,
  ...
  nutrition: () => import("../../modules/nutrition/App.svelte") as unknown as Promise<StarterModule>,
  ...
  flashcards: () => import("../../modules/flashcards/App.svelte") as unknown as Promise<StarterModule>,
  ...
  clipboard: () => import("../../modules/clipboard/App.svelte") as unknown as Promise<StarterModule>,
  breathing: () => import("../../modules/breathing/App.svelte") as unknown as Promise<StarterModule>,
  "voice-memos": () => import("../../modules/voice-memos/App.svelte") as unknown as Promise<StarterModule>,
  countdown: () => import("../../modules/countdown/App.svelte") as unknown as Promise<StarterModule>,
  telemetry: () => import("../../modules/telemetry/App.svelte") as unknown as Promise<StarterModule>,
};
