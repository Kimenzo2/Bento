...
export default function WelcomeEmail({ userName }: WelcomeEmailProps) {
  return (
    <GenesisLayout preview="Welcome to Genesis — start creating visual stories with AI">
      ...
      {/* Heading */}
      <Text style={heading(28)}>Welcome to Genesis, {userName}.</Text>

      {/* Body */}
      <Text style={body()}>
        You&rsquo;ve joined a community of creators building illustrated stories, visual learning
        content, and character worlds — all powered by AI.
      </Text>
      ...
      <Text style={body({ size: 13, color: '#8B7E74', margin: '0' })}>
        Need help getting started? Reply to this email and our team will guide you through your
        first project.
      </Text>
    </GenesisLayout>
  );
