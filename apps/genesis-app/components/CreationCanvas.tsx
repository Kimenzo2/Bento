...
const Mascot = memo(({ src, alt, position, delay = '0s' }: MascotProps) => {
  const positionClasses = useMemo(() => {
    const positions = {
      'header-left':
        'absolute left-1 md:left-4 xl:left-12 top-4 md:top-8 w-20 md:w-28 xl:w-36 opacity-95 md:opacity-100',
      'header-right':
        'absolute right-1 md:right-4 xl:right-12 top-4 md:top-8 w-20 md:w-28 xl:w-36 opacity-95 md:opacity-100',
...
const CreationCanvas: React.FC<CreationCanvasProps> = ({
  ...
  usePageSEO({
    ...
    description:
      'Create stunning AI-powered visual stories, illustrated books, and educational content with Genesis. Choose a style and let AI bring your ideas to life.',
    canonical: '/create',
  });
  ...
  const [selectedTemplateStructure, setSelectedTemplateStructure] = useState<
    BookTemplate['structure'] | undefined
  >(undefined);
  ...
  return (
    <>
      <section
        aria-label={t('creationCanvas.sectionAria', 'Creation canvas')}
        className="w-full flex flex-col items-center pb-32 animate-fadeIn relative"
      >
        {/* ===== OPTIMIZED MASCOTS ===== */}
        <Mascot
        ...
        />
        <Mascot
          src="/assets/mascots/wise-owl.png"
          alt={t('creationCanvas.mascotWiseOwl', 'Wise Owl')}
        ...
        >
          ...
          <p className="font-body text-[15px] leading-relaxed md:text-xl text-cocoa-light max-w-2xl mx-auto pt-2">
            {t(
              'creationCanvas.heroDescription',
          ...
          >
            ...
            >
              <QuickStartCard
                ...
                desc={t(
                  'creationCanvas.quickStartChildrenDesc',
                  'Create a magical tale with vibrant illustrations and moral lessons.'
                )}
            ...
            >
              <QuickStartCard
                ...
                desc={t(
                  'creationCanvas.quickStartLifeInColourDesc',
                  'Turn a camera-roll moment or uploaded photo into a finished colouring page, then expand it into a book only if you want to.'
                )}
            ...
            >
              <QuickStartCard
                ...
                desc={t(
                  'creationCanvas.quickStartInfographicsDesc',
                  'Create stunning educational infographics with AI-powered visuals.'
                )}
        ...
        {savedBooks.length > 0 && !prompt && (
          <div className="w-full max-w-6xl px-4 mb-16">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="font-heading font-bold text-3xl text-charcoal-soft">
                  {t('creationCanvas.mySavedBooks', 'My Saved Books')}
                </h2>
                <p className="text-cocoa-light text-sm mt-1">
                  {t('creationCanvas.savedBooksCount', '{{count}} {{bookLabel}} saved', {
                    count: savedBooks.length,
                    bookLabel:
                      savedBooks.length === 1
                        ? t('creationCanvas.bookSingular', 'book')
                        : t('creationCanvas.bookPlural', 'books'),
                  })}
                </p>
              </div>
        ...
        {!isLoadingBooks && savedBooks.length === 0 && !prompt && (
          ...
          >
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="font-heading font-bold text-charcoal-soft text-lg">
                  {t('creationCanvas.libraryEmpty', 'Your library is empty')}
                </p>
                <p className="text-cocoa-light text-sm mt-1">
                  {t(
                    'creationCanvas.libraryEmptyHint',
                    'Pick a Quick Start above or describe your own story to begin.'
                  )}
                </p>
              </div>
              <div className="flex items-center gap-1.5 text-xs text-coral-burst/80 font-medium">
                ...
                <span>
                  {t('creationCanvas.firstMasterpieceAwaits', 'Your first masterpiece awaits')}
                </span>
              </div>
            </div>
          </motion.div>
          ...
          <div className="bg-surface rounded-2xl sm:rounded-4xl p-6 sm:p-8 md:p-12 border border-peach-soft relative overflow-hidden min-h-[calc(100vh-250px)] sm:min-h-[600px]">
            ...
            {isGenerating && (
              <div className="absolute inset-0 z-50 bg-surface/90  flex flex-col items-center justify-center animate-fadeIn">
                ...
                <p className="text-cocoa-light text-center max-w-md px-4 animate-pulse">
                  {generationStatus ||
                    t(
                      'creationCanvas.craftingStory',
                      'Crafting your story, characters, and world...'
                    )}
                </p>
              </div>
            )}
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-10">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-cocoa-light">
                    {t('creationCanvas.chooseYourOwnAdventure', 'Choose-your-own-adventure')}
                  </div>
                </div>
              </Button>
              ...
              <Button
                ...
                className={`flex-1 p-4 flex gap-4 group ${
                  educational ? 'border-blue-400 bg-blue-50' : 'hover:border-blue-400/50'
                }`}
              >
                <div
                ...
                <div className="text-left">
                  <div className="font-heading font-bold text-charcoal-soft">
                    {t('creationCanvas.educational', 'Educational')}
                  </div>
                  <div className="text-xs text-cocoa-light">
                    {t('creationCanvas.learningAndVocabulary', 'Learning & Vocabulary')}
                  </div>
                </div>
              </Button>
            </div>
            ...
            <div ref={promptSectionRef} className="mb-10">
              ...
              <Textarea
                ...
                placeholder={t(
                  'creationCanvas.promptPlaceholder',
                  'Once upon a time, in a land made of candy...'
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
              ...
              <div className="space-y-3">
                ...
                <Select value={audience} onValueChange={setAudience}>
                  <SelectTrigger className="w-full">
                    <SelectValue
                      placeholder={t('creationCanvas.selectAudience', 'Select audience')}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value={t('creationCanvas.audienceToddlers13', 'Toddlers 1-3')}>
                      {t('creationCanvas.audienceToddlers13', 'Toddlers 1-3')}
                    </SelectItem>
                    <SelectItem value={t('creationCanvas.audienceChildren46', 'Children 4-6')}>
                      {t('creationCanvas.audienceChildren46', 'Children 4-6')}
                    </SelectItem>
                    <SelectItem value={t('creationCanvas.audienceChildren79', 'Children 7-9')}>
                      {t('creationCanvas.audienceChildren79', 'Children 7-9')}
                    </SelectItem>
                    <SelectItem value={t('creationCanvas.audiencePreTeens1012', 'Pre-teens 10-12')}>
                      {t('creationCanvas.audiencePreTeens1012', 'Pre-teens 10-12')}
                    </SelectItem>
                    <SelectItem value={t('creationCanvas.audienceYoungAdult', 'Young Adult')}>
                      {t('creationCanvas.audienceYoungAdult', 'Young Adult')}
                    </SelectItem>
                    <SelectItem value={t('creationCanvas.audienceStakeholders', 'Stakeholders')}>
                      {t('creationCanvas.audienceStakeholders', 'Stakeholders')}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            {educational && (
              <div className="bg-white/95 backdrop-blur-sm border border-cream-soft rounded-3xl p-6 mb-10 shadow-sm animate-fadeIn">
                <div className="flex items-center gap-2 text-primary mb-6">
                  <Leaf className="w-5 h-5" />
                  <h3 className="font-heading font-bold text-lg text-charcoal-base ">
                    {t('creationCanvas.learningGoals', 'Learning Goals')}
                  </h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Select value={learningSubject} onValueChange={setLearningSubject}>
                      <SelectTrigger className="w-full bg-white border-cream-soft">
                        <SelectValue
                          placeholder={t('creationCanvas.selectSubject', 'Select subject')}
                        />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v: string) =>
                        setLearningDifficulty(v as typeof learningDifficulty)
                      }
                    >
                      <SelectTrigger className="w-full bg-white border-cream-soft">
                        <SelectValue
                          placeholder={t('creationCanvas.selectDifficulty', 'Select difficulty')}
                        />
                      </SelectTrigger>
                      <SelectContent className="bg-white border-cream-soft">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      ...
                      placeholder={t(
                        'creationCanvas.learningObjectivesPlaceholder',
                        'e.g., Counting to 10, Understanding Photosynthesis, Managing Anger...'
                      )}
                    />
                  </div>
                  <div className="md:col-span-2">
                    ...
                    <div className="grid grid-cols-1 xs:grid-cols-3 gap-3">
                      {[
                        ...
                        >
                          ...
                          <div
                            className={`text-xs mt-1 ${integrationMode === mode.id ? 'text-primary/80' : 'text-cocoa-light '}`}
                          >
                            {mode.desc}
                          </div>
                        </Button>
                  ...
                  <div className="md:col-span-2 mt-2 pt-6 border-t border-cream-soft ">
                    ...
                    <p className="text-sm text-cocoa-light  mb-4">
                      {t(
                        'creationCanvas.teachingGuideDescription',
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="font-bold text-charcoal-base ">
                              {t(
                                'creationCanvas.selectedTeacherGuide',
                                '{{name}} will be your guide!',
                  ...
                  <>
                    ...
                    <span className="text-left leading-[1.02] tracking-[0.01em]">
                      <span className="block text-[12px] font-medium">
                        {t('creationCanvas.generate', 'Generate')}
                      </span>
                      <span className="block text-[12px] font-semibold">
                        {t('creationCanvas.masterpiece', 'Masterpiece')}
                      </span>
                    </span>
                  </>
                )}
