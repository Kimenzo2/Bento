                ...
                <div className="mt-8 max-w-2xl space-y-3">
                  ...
                  {currentPage.choices.map((choice, idx) => (
                    <Button
                      ...
                      className="w-full min-h-10 rounded-[12px] px-3.5 py-2.5 text-left justify-start border-[0.5px] border-charcoal-soft/22 bg-surface/80 text-charcoal-soft hover:text-coral-burst hover:bg-surface hover:border-coral-burst/35 transition-all duration-200"
                    >
