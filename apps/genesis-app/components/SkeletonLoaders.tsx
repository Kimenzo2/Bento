...
export const SkeletonBase: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative overflow-hidden bg-peach-light/50  rounded ${className}`}>
    <motion.div
...
export const EditorSkeleton: React.FC = () => (
  <div className="flex h-full">
    {/* Sidebar */}
    <div className="w-64 border-r border-peach-soft  p-4 space-y-3">
...
export const IllustrationSkeleton: React.FC<{ aspectRatio?: string }> = ({
  aspectRatio = '1/1',
}) => (
...
export const GenerationProgressSkeleton: React.FC = () => (
  <div className="bg-surface  rounded-2xl p-6 border border-peach-soft max-w-md mx-auto">
