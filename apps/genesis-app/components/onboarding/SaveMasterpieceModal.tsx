...
export const SaveMasterpieceModal: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full min-h-full max-w-lg mx-auto px-(--ob-container-padding) py-8 flex flex-col items-center overflow-y-auto">
      ...
      <div className="absolute top-[10%] -left-[15%] w-100 h-100 rounded-full bg-purple-600/15 blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-[10%] -right-[10%] w-[350px] h-[350px] rounded-full bg-blue-600/15 blur-3xl pointer-events-none -z-10" />
        ...
        <p className="text-white/60 text-sm leading-relaxed max-w-xs mx-auto">
          {successMessage ? (
            ...
            <>
              ...
              <strong className="text-white/80">{getThemeName()}</strong> and unlock the full
              Genesis experience.
            </>
          )}
        </p>
