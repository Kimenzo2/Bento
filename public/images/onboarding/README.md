...
- `feature-editor.png` - Glowing star tablet
- `role-mentor.png` - Crystal owl with monocle
- `role-explorer.png` - Telescope with compass
...
- `skill-beginner.png` - Sprouting seedling
- `skill-pro.png` - Lightning in sphere
- `cadence-daily.png` - Eternal flame
...
- Roles: 200x200px (transparent PNG)
- Quiz options: 120x120px (transparent PNG)

All images should have transparent backgrounds for best results on the dark UI.
