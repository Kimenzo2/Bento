...
export const fontPairings: FontPairing[] = [
  {
    ...
    preview: {
      ...
      bodyText:
        'Once upon a time, in a forest far away, there lived a tiny squirrel who loved to bake cookies.',
    },
  ...
  },
  {
    ...
    preview: {
      ...
      bodyText:
        'The study of history reveals patterns in human behavior that have repeated throughout the centuries.',
    },
  ...
  },
  {
    ...
    preview: {
      ...
      bodyText:
        'Algorithms are step-by-step instructions that tell a computer how to perform a specific task.',
    },
  ...
  },
  {
    ...
    preview: {
      ...
      bodyText:
        'In a land of clouds and stardust, a young dragon dreamed of flying higher than any dragon before.',
    },
  ...
  },
  {
    ...
    preview: {
      ...
      bodyText:
        'True elegance is not just about appearance, but about the grace with which one moves through the world.',
    },
  ...
  },
  {
    ...
    preview: {
      ...
      bodyText:
        'Today was an adventure! I discovered a hidden path in the garden that led to a secret meadow.',
    },
