    ...
    <div className="animate-fadeIn">
      <div className="mb-6">
        ...
        <p className="text-cocoa-light text-sm">
          Choose a font pairing that sets the perfect tone for your stories.
        </p>
      </div>
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-white/50 z-50 flex items-center justify-center backdrop-blur-sm">
          <div className="bg-white p-4 rounded-2xl border-2 border-peach-soft flex items-center gap-3">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-100 text-sm text-blue-800 flex gap-3">
        ...
        <p>
          <strong>Pro Tip:</strong> Fonts are automatically optimized for readability. Changing
          fonts will update your entire interface and all your books instantly.
        </p>
      </div>
    </div>
  );
