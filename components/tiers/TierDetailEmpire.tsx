...
const features: FeatureCard[] = [
  ...
  },
  {
    ...
    items: ['SSO/SAML integration', 'Custom data retention', 'Audit logging', 'GDPR & HIPAA ready'],
  },
];
...
const testimonials: Testimonial[] = [
  {
    ...
    avatar: 'MT',
    quote:
      "Genesis Empire isn't a tool for us—it's infrastructure. We've integrated it into our core product and serve millions of readers with custom-generated content.",
    metric: '10M+',
  ...
  },
  {
    ...
    avatar: 'SC',
    quote:
      'The custom AI training transformed our workflow. We generated an entire K-5 curriculum with consistent characters that students recognize book to book.',
    metric: '2,400',
  ...
  },
  {
    ...
    avatar: 'RO',
    quote:
      'The API lets us build features we never imagined. Our users create personalized books with their own photos as characters—all powered by Genesis.',
    metric: '500K',
...
const workflowSteps = [
  {
    ...
    description:
      "Meet your dedicated success team. We'll understand your goals, audit your workflows, and design a custom implementation plan aligned with your organization's objectives.",
  },
  {
    number: 2,
    title: 'Custom Integration',
    description:
      'Our engineers work alongside yours to integrate Genesis into your systems. Custom AI model training, API implementation, SSO setup—we handle the complexity.',
  },
  {
    number: 3,
    title: 'Scale & Optimize',
    description:
      "Launch with confidence knowing you have 24/7 support and dedicated resources. Regular business reviews ensure we're always aligned with your evolving needs.",
  },
];
...
const personas: PersonaCard[] = [
  {
    ...
    avatar: 'GP',
    quote:
      'We needed a solution that could handle our scale and integrate with our existing systems. Genesis Empire was the only option.',
  ...
  },
  {
    ...
    avatar: 'GA',
    quote:
      'Compliance requirements made most solutions impossible. Genesis met every security standard.',
  ...
  },
  {
    ...
    avatar: 'HS',
    quote:
      'Therapeutic storytelling needed HIPAA compliance and customization. Genesis delivered both.',
...
const caseStudies: CaseStudy[] = [
  {
    ...
    industry: 'Publishing',
    challenge:
      'A top-5 educational publisher needed to modernize their illustrated content pipeline. Legacy workflows took 18+ months per title and costs were unsustainable.',
    solution:
      'Genesis Empire integrated directly into their editorial workflow. Custom AI models trained on their proprietary illustration styles. API enables automated pipeline from manuscript to illustrated proof.',
    results: [
    ...
    quote:
      "Genesis didn't just improve our process—it fundamentally changed what's possible in educational publishing.",
  ...
  },
  {
    ...
    challenge:
      "An edtech unicorn wanted to offer personalized illustrated stories as a differentiator, but couldn't find a solution that met their scale (20M+ users) and compliance requirements.",
    solution:
      "Genesis Empire's API powers their story engine. Custom character training means each student can see themselves in stories. SOC 2 compliance met their enterprise customer requirements.",
    results: [
    ...
    quote:
      'The ROI was immediate. Enterprise customers that previously said no are now signing multi-year deals.',
  ...
  },
  {
    ...
    industry: 'Healthcare',
    challenge:
      'A major pediatric hospital network wanted to use illustrated stories for therapeutic purposes—helping children process difficult diagnoses and procedures—but needed HIPAA compliance.',
    solution:
      'Genesis Empire with custom data retention policies, HIPAA-compliant infrastructure, and specialized training for therapeutic content. Staff can create personalized stories for individual patients.',
    results: [
    ...
    quote:
      "We're helping children face their fears through personalized stories. The clinical outcomes have exceeded our research expectations.",
...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "We train Genesis's AI models on your proprietary content—your illustration styles, your characters, your brand elements. The result is an AI that generates content uniquely yours. This training is exclusive to your organization and creates a competitive moat.",
  },
  {
    category: 'technical',
    question: 'How does API integration work?',
    answer:
      'Full RESTful API with comprehensive documentation. Endpoints for book creation, style selection, image generation, export—everything you can do in the UI, you can automate via API. We provide SDKs for popular languages and webhook support for event-driven architectures.',
  },
  {
    category: 'enterprise',
    question: 'What security certifications do you have?',
    answer:
      'SOC 2 Type II certified. GDPR compliant. HIPAA-ready with BAA available. SSO/SAML support for enterprise identity management. Custom data retention policies. Full audit logging. We can provide security documentation for your procurement process.',
  },
  {
    category: 'enterprise',
    question: "What's included in dedicated infrastructure?",
    answer:
      'Dedicated GPU allocation ensures your generation requests are never queued behind other customers. Priority processing for all API calls. 99.9% uptime SLA with financial guarantees. Geographic region selection for data residency requirements.',
  },
  {
    category: 'support',
    question: 'What does white-glove support mean?',
    answer:
      "Dedicated account team including Technical Account Manager, Customer Success Manager, and Solutions Architect. 24/7 phone support with 1-hour response SLA. Quarterly executive business reviews. Custom training for your team. We're partners in your success.",
  },
  {
    category: 'comparison',
    question: 'Why Empire over Studio for our organization?',
    answer:
      'Studio is for teams; Empire is for organizations where Genesis is critical infrastructure. You need Empire if: you require API access for automation, you want custom AI training for proprietary styles, you need unlimited team size, you require enterprise security/compliance, or you need SLA guarantees.',
  },
  {
    category: 'enterprise',
    question: 'Can we negotiate custom terms?',
    answer:
      "Absolutely. Empire is designed for enterprise needs. Multi-year commitments, volume discounts, custom SLAs, on-premise deployment options, custom development—let's discuss your requirements.",
  },
  {
    category: 'technical',
    question: "What's the API rate limit?",
    answer:
      "Empire has no rate limits. Burst to whatever capacity you need. We'll provision infrastructure to match your requirements. Typical customers process 100K-500K API calls monthly.",
  },
  {
    category: 'enterprise',
    question: 'How long does implementation take?',
    answer:
      'Standard enterprise implementation is 4-8 weeks depending on complexity. This includes onboarding, API integration, custom AI training if needed, SSO setup, and team training. We can expedite for urgent needs.',
  },
  {
    category: 'licensing',
    question: 'What are the licensing terms?',
    answer:
      'Full commercial rights to all generated content. Enterprise redistribution rights. API usage for your products and services. White-label options available. Custom licensing terms negotiable for specific use cases.',
  },
  {
    category: 'support',
    question: 'Is there a pilot program?',
    answer:
      'Yes. We offer a 30-day enterprise pilot with full Empire access. Work with our team to validate the solution for your use case before committing. Pilot fees apply toward your first year if you proceed.',
  },
  {
    category: 'technical',
    question: 'Can Genesis be deployed on-premise?',
    answer:
      'For qualifying enterprise customers, we offer on-premise or private cloud deployment options. This meets requirements for organizations with strict data residency or air-gapped infrastructure needs.',
  },
];
        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-linear-to-br from-gold-sunshine/10 to-coral-burst/10 rounded-2xl p-6 border border-gold-sunshine/20">
              ...
              <p className="text-charcoal-soft/70 text-sm">
                Dedicated team invested in your success. We grow when you grow.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 border border-peach-soft">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-between py-3 border-b border-charcoal-soft/5 last:border-0"
                >
      ...
      >
        ...
        <div className="mt-12 text-center">
          <p className="text-charcoal-soft/70 max-w-2xl mx-auto">
            Every Empire engagement begins with a 30-day enterprise pilot. Experience the full
            platform with your actual use case before making a commitment. Our dedicated team
            ensures your pilot success.
          </p>
        </div>
      </SectionWrapper>
