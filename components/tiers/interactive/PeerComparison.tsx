    ...
    <div className="bg-surface rounded-2xl p-8 border border-peach-soft my-12">
      <div className="text-center mb-8">
        ...
        <p className="text-charcoal-soft/60">
          Compare your current output with top Genesis creators
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        {/* Genesis path */}
        <div
          className={`p-6 rounded-xl border border-${tier.accentColor}-100 bg-${tier.accentColor}-50`}
        >
          <div
            className={`text-xs font-bold text-${tier.accentColor}-600 uppercase tracking-wider mb-2`}
          >
            With Genesis {tier.name}
          </div>
          <div className="text-charcoal-soft text-sm mb-4">
            Genesis creators at the {selectedLevel} stage typically produce:
          </div>
