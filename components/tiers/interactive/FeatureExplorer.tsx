    ...
    content: (
      <div className="p-6 bg-gray-900 text-white rounded-xl h-64 flex flex-col items-center justify-center border border-white/10 relative overflow-hidden">
        ...
        <div className="flex gap-4 mb-4">
          <div className="w-16 h-20 bg-gray-800 rounded-lg border border-gray-700 flex items-center justify-center text-xs text-gray-400">
            Watercolor
          </div>
      ...
      <div className="w-full md:w-1/3 space-y-2">
        ...
        {features.map((feature) => {
          ...
          return (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg flex items-center justify-center ${isActive ? `bg-${tier.accentColor}-200 text-${tier.accentColor}-700` : 'bg-gray-100 text-gray-500'}`}
              >
