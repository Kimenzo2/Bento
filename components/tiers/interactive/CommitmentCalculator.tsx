  ...
  return (
    <div className="bg-linear-to-br from-charcoal-soft to-black rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
        <div>
          <h3 className="font-heading font-bold text-lg sm:text-xl md:text-2xl mb-2 md:mb-4">
        ...
        <div className="bg-white/5 rounded-xl md:rounded-2xl p-4 md:p-6 border border-white/10">
          ...
          <div className="space-y-6 relative">
            ...
            <div className="flex items-center gap-4 relative">
              ...
              <div className="text-sm">
                <span className="text-green-400 font-bold px-2 py-0.5 rounded bg-green-500/10">
                  +$ {totalProfit.toLocaleString()}
                </span>
