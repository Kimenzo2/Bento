...
const steps = [
  {
    ...
    icon: Upload,
    desc: 'Paste your existing manuscript or notes.',
  },
  {
    id: 2,
    title: 'Style Match',
  ...
  },
  {
    ...
    title: 'Auto-Format',
    icon: FileText,
    desc: 'Instantly convert text to storyboard layout.',
  },
];
      ...
      <div className="flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          ...
          <p className="text-charcoal-soft/70 mb-6">
            Worried about losing work? Don't be. Genesis imports your existing drafts and transforms
            them in seconds.
          </p>
