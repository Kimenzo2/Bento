...
const testimonials: Testimonial[] = [
  {
    ...
    avatar: 'RN',
    quote:
      'We went from producing 5 client books per month to 40. Our margins doubled and client satisfaction is at an all-time high. Studio is our secret weapon.',
    metric: '8x',
  ...
  },
  {
    ...
    avatar: 'DP',
    quote:
      'The Brand Hub keeps everything consistent across our curriculum. Teachers love it, kids love it, and our district partnerships grew 300% this year.',
    metric: '300%',
  ...
  },
  {
    ...
    avatar: 'AF',
    quote:
      'We replaced a team of 3 freelance illustrators with Genesis Studio. Same quality, 10x the speed, and our creative team actually enjoys the process now.',
    metric: '$180K',
...
const workflowSteps = [
  {
    ...
    description:
      'Configure Brand Hub with your style guidelines, color palettes, and preferred illustration styles. Create templates for consistent output across your entire team.',
  },
  {
    number: 2,
    title: 'Collaborate & Create',
    description:
      'Assign projects to team members, share assets, and work together in real-time. Built-in version control ensures nothing gets lost and everyone stays aligned.',
  },
  {
    number: 3,
    title: 'Scale & Deliver',
    description:
      'Produce unlimited content for clients, campaigns, or curriculum. Export in any format—white-label PDFs, videos, or print-ready files with your branding.',
  },
];
...
const personas: PersonaCard[] = [
  {
    ...
    avatar: 'AO',
    quote:
      'Genesis lets us offer illustrated book services without hiring illustrators. Our profit per project increased 4x.',
  ...
  },
  {
    ...
    avatar: 'EB',
    quote:
      "We're building the future of personalized learning content. Genesis is our production engine.",
...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge:
      "A 12-person creative agency wanted to offer illustrated children's books as a premium service but couldn't justify hiring full-time illustrators for sporadic projects.",
    solution:
      'Genesis Studio enabled their existing designers to create professional illustrated books. The Brand Hub ensures client brand consistency across deliverables.',
    results: [
    ...
    quote:
      "We added a six-figure revenue stream without adding headcount. Genesis Studio is the best investment we've made.",
  ...
  },
  {
    ...
    challenge:
      'A diverse school district needed culturally representative reading materials but had no budget for custom content development.',
    solution:
      'Teachers use Genesis Studio to create stories featuring characters that look like their students, teaching concepts aligned to their specific curriculum.',
    results: [
    ...
    quote:
      'Our students finally see themselves in their reading materials. Engagement has never been higher.',
  ...
  },
  {
    ...
    challenge:
      'A digital-first publisher wanted to rapidly test book concepts before committing to full production with traditional illustrators.',
    solution:
      'Genesis Studio for rapid prototyping—they create MVP books, test with focus groups, then refine winners for full release.',
    results: [
    ...
    quote:
      'We used to bet big on single titles. Now we test 10 concepts for the same cost and only scale winners.',
...
const competitors = [
  ...
  {
    name: 'Other AI + Collaboration',
    price: '$200+/month',
    features: 'Separate tools, no brand control',
  },
];
...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Truly unlimited. Create as many books as you want each month—there's no cap. Fair use applies (no automated bulk generation), but normal business use has no practical limits. Many Studio customers create 50-100+ books monthly.",
  },
  {
    category: 'technical',
    question: 'How does team collaboration work?',
    answer:
      'Each of your 5 team seats gets a full Genesis account. Team members can share projects, assets, and brand settings. Real-time collaboration lets multiple people work on a book simultaneously. Admins can set permissions for who can publish or export.',
  },
  {
    category: 'technical',
    question: 'What is Brand Hub and how do I use it?',
    answer:
      'Brand Hub is your central repository for brand assets and guidelines. Upload logos, set color palettes, define preferred styles, and create templates. Every book your team creates will have access to these brand elements for consistent output.',
  },
  {
    category: 'usage',
    question: 'Can different team members have different permissions?',
    answer:
      'Yes! Admins can set role-based permissions. Options include: Admin (full access), Editor (create and edit), Viewer (read-only), and Publisher (can export and distribute). Customize access to match your team structure.',
  },
  {
    category: 'comparison',
    question: 'Why Studio over Creator for my agency?',
    answer:
      'Creator limits you to 30 books/month and 12 pages each—fine for individuals, but agencies need more. Studio gives you unlimited books, 500 pages each, team seats for collaboration, Brand Hub for consistency, and premium support for enterprise needs.',
  },
  {
    category: 'licensing',
    question: 'Can we white-label books for clients?',
    answer:
      'Absolutely. Studio includes white-label export options. Remove all Genesis branding from PDFs, add your agency logo, include client branding—deliver as if you created it entirely in-house.',
  },
  {
    category: 'support',
    question: "What's included in premium support?",
    answer:
      "4-hour response time guarantee, dedicated success manager for your account, private Slack channel for your team, and quarterly strategy calls to optimize your workflow. We're invested in your success.",
  },
  {
    category: 'technical',
    question: 'How do video book exports work?',
    answer:
      'Convert any book into a video with animated page turns, optional narration, and background music. Perfect for social media, YouTube, or client presentations. Export in MP4 format in various aspect ratios.',
  },
  {
    category: 'comparison',
    question: 'When should we consider Empire instead?',
    answer:
      'Consider Empire if you need more than 5 team seats, custom AI model training for unique styles, API access for automation, or enterprise-grade SLAs. Empire is for organizations where Genesis is mission-critical infrastructure.',
  },
  {
    category: 'licensing',
    question: 'Does the commercial license cover client work?',
    answer:
      "Yes. Your Studio license covers work you create for clients. They can sell the books, use them for marketing, or distribute as they wish. You're transferring the commercial rights when you deliver to clients.",
  },
  {
    category: 'support',
    question: 'Is there onboarding for our team?',
    answer:
      "Yes! Every Studio account includes a dedicated onboarding session with your success manager. We'll help you set up Brand Hub, train your team, and establish workflows optimized for your use case.",
  },
  {
    category: 'technical',
    question: 'Can we integrate with our existing tools?',
    answer:
      'Studio includes export integrations with common tools—direct upload to cloud storage, Zapier connections, and more. For deeper integrations, consider Empire tier which includes full API access.',
  },
];
...
const TierDetailStudio: React.FC = () => {
  ...
  const handleDownloadPDF = () => {
    // TODO: Implement PDF download for studio tier
  };
    ...
    <div className="min-h-screen bg-white font-body selection:bg-indigo-200 selection:text-indigo-900">
      ...
      >
        <div className="mt-4 flex justify-center">
          <Button
            ...
            className="text-charcoal-soft/60 hover:text-indigo-600 underline decoration-dotted"
          >
      ...
      >
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 border-2 border-peach-soft">
              ...
              <p className="text-charcoal-soft/70 text-sm">
                Add illustrated book services to your offerings. 85%+ margins on a new revenue
                stream.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-6 border-2 border-peach-soft">
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-peach-soft">
              ...
              <p className="text-charcoal-soft/70 text-sm">
                Brand Hub ensures every book matches your guidelines. Consistency at scale.
              </p>
            </div>
          </div>
          ...
          <div className="bg-linear-to-br from-coral-burst/5 to-gold-sunshine/5 rounded-2xl p-8 border border-coral-burst/20">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-charcoal-soft/70 mb-4">
                  Most agencies recoup their Studio investment within the first month. See how much
                  you could save and earn.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-peach-soft">
                <div className="text-center">
                  ...
                  <div className="text-charcoal-soft/60 mt-2">
                    Average annual savings for agencies
                  </div>
                  <div className="text-xs text-charcoal-soft/40 mt-1">
                    Based on 15 books/month at $1,000 avg freelance cost
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        ...
        <div className="mt-16 bg-charcoal-soft rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-white/70 mb-6 max-w-xl mx-auto">
            Watch how Bright Minds Agency delivers 40+ client projects per month using Genesis
            Studio's team collaboration features.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="outline" size="lg">
              <div className="w-10 h-10 rounded-full bg-coral-burst flex items-center justify-center">
                <div className="w-0 h-0 border-l-8 border-l-white border-y-[6px] border-y-transparent ml-1" />
              </div>
              Watch Demo
            </Button>
            <Button
      ...
      <SectionWrapper
        ...
        className="bg-linear-to-b from-white to-indigo-50/30"
        background="bg-indigo-50/30"
      >
      ...
      <SectionWrapper
        ...
        className="bg-linear-to-b from-indigo-50/30 to-white"
        background="bg-indigo-50/30"
      >
      ...
      >
        ...
        <div className="mt-12 text-center">
          <p className="text-charcoal-soft/70 max-w-2xl mx-auto">
            Every Studio subscription includes a 14-day free trial with full access to all features.
            Your team can test everything before committing. Plus, our 30-day money-back guarantee
            means zero risk—if Studio doesn't transform your workflow, we'll refund you completely.
          </p>
        </div>
      </SectionWrapper>
