          ...
          <div className="grid grid-cols-2 gap-3">
            {styles.map((style) => (
              <button
                ...
                className={`p-3 sm:p-4 rounded-xl border-2 transition-all text-left min-h-[44px] active:scale-95 ${
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            {characters.map((char) => (
              <button
                ...
                className={`p-3 sm:p-4 lg:p-5 rounded-xl border-2 transition-all flex flex-col items-center justify-center gap-1.5 sm:gap-2 aspect-square min-h-[44px] active:scale-95 ${
