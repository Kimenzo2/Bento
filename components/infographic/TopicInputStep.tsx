  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-fadeIn">
      ...
      <div className="space-y-3">
        <label className="block font-heading font-bold text-xs sm:text-sm text-cocoa-light uppercase tracking-wide">
          Topic
        </label>
        <input
          type="text"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {ageGroups.map((age) => (
            <button
              ...
              className={`p-3 sm:p-4 rounded-xl border-2 transition-all text-left group relative overflow-hidden min-h-[44px] active:scale-95 ${
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
          {types.map((type) => (
            <button
              ...
              className={`p-2.5 sm:p-3 rounded-xl border-2 transition-all text-center text-xs sm:text-sm font-medium min-h-[44px] active:scale-95 ${
