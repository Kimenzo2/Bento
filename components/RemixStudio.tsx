                            ...
                            {world.tags.length > 0 && (
                              <div className="flex flex-wrap gap-1 mt-3">
                                {world.tags.slice(0, 3).map((tag) => (
                                  <span
                                    key={tag}
                                    className="px-2 py-0.5 bg-purple-500/20 rounded-full text-xs text-purple-300"
                                  >
                                    {tag}
                                  </span>
                                ))}
                  ...
                  {publishSuccess ? (
                    ...
                    >
                      ...
                      <p className="text-white/60">
                        Your world is now available for others to remix
                      </p>
                    </motion.div>
                  ) : (
                    <>
