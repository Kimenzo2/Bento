...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border border-coral-burst bg-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral-burst/30 focus-visible:ring-offset-2 focus-visible:ring-offset-cream-base disabled:pointer-events-none disabled:opacity-50 hover:scale-110 active:scale-95 cursor-grab active:cursor-grabbing" />
  </SliderPrimitive.Root>
));
