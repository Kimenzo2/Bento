        ...
        <div className="p-2 sm:p-3">
          ...
          {showUser && visual.user && (
            ...
            >
              <img
                src={
                  visual.user.avatar_url ||
                  `https://api.dicebear.com/7.x/avataaars/svg?seed=${visual.user_id}`
                }
            ...
            {showReactions && visual.reaction_count > 0 && (
              <MiniReactionDisplay
                reactions={
                  reactions.length > 0
                    ? reactions
                    : [{ type: 'heart', count: visual.reaction_count }]
                }
              />
            )}
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-cocoa-light/60">
            ...
            {visual.reaction_count > 0 && (
              <>
                <span>•</span>
                <span>
                  {REACTION_EMOJIS.heart} {visual.reaction_count}
                </span>
              </>
            )}
          </div>
    ...
    return (
      <div className="relative rounded-3xl overflow-hidden border border-peach-soft">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          ...
          <p className="text-white/80 text-sm mb-4 line-clamp-2">{visual.prompt}</p>
          ...
          <div className="flex items-center justify-between">
            {visual.user && (
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-white font-medium">{visual.user.display_name}</span>
              </div>
            )}
