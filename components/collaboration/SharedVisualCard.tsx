        ...
        return (
            ...
            >
                ...
                <div className="relative aspect-square overflow-hidden">
                    ...
                    {/* Remix badge */}
                    {visual.parent_id && (
                        <div className="absolute top-1.5 sm:top-2 right-1.5 sm:right-2 bg-purple-500 text-white text-[10px] sm:text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full flex items-center gap-0.5 sm:gap-1">
                            <GitFork className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
                            <span className="hidden xs:inline">Remix</span>
                        </div>
                    )}
                    ...
                    `}>
                        ...
                        <div className="absolute top-1.5 sm:top-2 right-1.5 sm:right-2 flex gap-1.5 sm:gap-2">
                            <button
                                onClick={(e) => { e.stopPropagation(); onExpand?.(visual); }}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3">
                            <p className="text-white text-[11px] sm:text-sm font-medium line-clamp-2 mb-1.5 sm:mb-2">
                            ...
                            {showActions && (
                                <div className="flex items-center gap-1.5 sm:gap-2">
                                    <button
                                        onClick={(e) => { e.stopPropagation(); onRemix?.(visual); }}
                    ...
                    {/* Dropdown menu - Mobile optimized as bottom sheet style */}
                    {showMenu && (
                        <>
                            <div className="fixed inset-0 z-40 bg-black/20 sm:bg-transparent" onClick={() => setShowMenu(false)} />
                            <div className="absolute top-10 sm:top-12 right-1.5 sm:right-2 z-50 bg-white rounded-xl shadow-xl border border-gray-200 py-1 min-w-[140px] sm:min-w-[160px] animate-fadeIn">
                                ...
                                <button
                                    className="w-full px-3 sm:px-4 py-2.5 sm:py-2 text-left text-xs sm:text-sm hover:bg-gray-50 active:bg-gray-100 flex items-center gap-2 text-gray-400"
                                >
                                    <Bookmark className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Save
                                </button>
                                <button
                                    className="w-full px-3 sm:px-4 py-2.5 sm:py-2 text-left text-xs sm:text-sm hover:bg-gray-50 active:bg-gray-100 flex items-center gap-2 text-red-400"
                                >
