          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img
                ...
                alt="Genesis"
                className="w-14 h-14 rounded-xl object-cover border border-peach-soft/40 shadow-sm"
              />
            ...
            <p className="text-xl text-cocoa-light font-body">
              Join thousands of creators bringing their stories to life with AI-powered
              illustrations and interactive narratives.
            </p>
          </div>
        ...
        <div className="bg-surface rounded-3xl border border-peach-soft p-8 lg:p-12">
          <div className="text-center mb-8">
            <img
              src="/genesis-icon.jpg"
              alt="Genesis"
              className="w-16 h-16 rounded-2xl mx-auto mb-6 object-cover border border-peach-soft/40 shadow-sm transform rotate-3"
            />
